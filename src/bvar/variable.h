...
//#include "butil/strings/string_piece.h" // std::string
#include <thread>
...
public:
    ...
    virtual void describe(std::ostream&, bool quote_string) = 0;
    ...
    int expose_as(const std::string& prefix,
...
inline ostream& operator<<(ostream &os, ::bvar::Variable &var) {
