...
//#include "type_traits.h"                     // butil::add_cr_non_integral
//#include "class_name.h"                      // class_name_str
#include "variable.h"                        // Variable
#include "combiner.h"                 // detail::AgentCombiner
//#include "sampler.h"                  // ReducerSampler
//#include "series.h"
//#include "window.h"
...
public:
    ...
    void describe(std::ostream& os, bool quote_string) {
...
public:
    ...
    Adder(const std::string &prefix, const std::string &name) : Base() {
...
private:
    ...
    Maxer(T default_value, const std::string &prefix, const std::string &name)
        : Base(default_value) {
        this->expose_as(prefix, name);
    }
